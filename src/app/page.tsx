...
const services = [
  {
    ...
    description: "Homes tailored to light, material and flow.",
  },
...
const testimonials = [
  {
    name: "A. Shah",
    testimonial:
      "They translated our needs into a home that feels inevitably right.",
  },
  {
    name: "R. Menon",
    testimonial:
      "Exquisite detailing. The kitchen works as beautifully as it looks.",
  },
];
...
export default function Home() {
  return (
    <div className="flex flex-col min-h-dvh bg-background text-foreground">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <p className="text-lg text-muted-foreground">
              Where luxury meets functionality. We craft immersive environments
              that transcend traditional boundaries and inspire extraordinary
              living.
            </p>
          ...
          <div className="grid gap-10 lg:grid-cols-3">
            <div className="space-y-2">
              ...
              <p className="text-muted-foreground text-lg">
                Every edge, seam and reveal is intentional—quiet rigor you can
                feel.
              </p>
            </div>
            <div className="space-y-2">
            ...
            <div className="space-y-2">
              ...
              <p className="text-muted-foreground text-lg">
                We choreograph light for golden-hour serenity throughout the
                day.
              </p>
            </div>
          </div>
      ...
      <section className="py-12 md:py-24 lg:py-32 bg-secondary/10">
        <div className="container px-4 md:px-6">
          <h2 className="text-3xl font-headline font-bold tracking-tight sm:text-4xl text-left mb-12">
            Testimonials
          </h2>
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
            {testimonials.map((testimonial, index) => (
              <Card
                key={index}
                className="border-none bg-transparent shadow-none p-6"
              >
